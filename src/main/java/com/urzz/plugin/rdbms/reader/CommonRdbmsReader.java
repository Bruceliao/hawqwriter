package com.urzz.plugin.rdbms.reader;
...
import com.urzz.plugin.rdbms.reader.Constant;
import com.urzz.plugin.rdbms.reader.Key;
import com.urzz.plugin.rdbms.reader.util.OriginalConfPretreatmentUtil;
import com.urzz.plugin.rdbms.reader.util.PreCheckTask;
import com.urzz.plugin.rdbms.reader.util.ReaderSplitUtil;
import com.urzz.plugin.rdbms.reader.util.SingleTableSplitUtil;
...
public class CommonRdbmsReader {
    ...
    public static class Task {
        ...
        public void init(Configuration readerSliceConfig) {
            ...
            //ob10的处理
            if (this.jdbcUrl.startsWith(com.urzz.plugin.rdbms.writer.Constant.OB10_SPLIT_STRING) && this.dataBaseType == DataBaseType.MySql) {
                String[] ss = this.jdbcUrl.split(com.urzz.plugin.rdbms.writer.Constant.OB10_SPLIT_STRING_PATTERN);
                if (ss.length != 3) {
