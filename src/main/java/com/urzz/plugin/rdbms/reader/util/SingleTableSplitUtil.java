...
public class SingleTableSplitUtil {
    private static final Logger LOG = LoggerFactory
            .getLogger(com.urzz.plugin.rdbms.reader.util.SingleTableSplitUtil.class);
    ...
    private static boolean isLongType(int type) {
        ...
        switch (com.urzz.plugin.rdbms.reader.util.SingleTableSplitUtil.DATABASE_TYPE) {
            case Oracle:
