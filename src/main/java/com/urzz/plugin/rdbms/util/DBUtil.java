...
import com.urzz.plugin.rdbms.reader.Key;
import com.urzz.plugin.rdbms.util.Constant;
import com.urzz.plugin.rdbms.util.DBUtilErrorCode;
import com.urzz.plugin.rdbms.util.DataBaseType;
import com.urzz.plugin.rdbms.util.RdbmsException;
...
public final class DBUtil {
    private static final Logger LOG = LoggerFactory.getLogger(com.urzz.plugin.rdbms.util.DBUtil.class);
...
//                    throw new Exception(DBUtilErrorCode.JDBC_NULL.toString());
    ...
    private static boolean isSlaveBehind(Connection conn) {
        try {
            ...
            if (com.urzz.plugin.rdbms.util.DBUtil.asyncResultSetNext(rs)) {
                String readOnly = rs.getString("Value");
                if ("ON".equalsIgnoreCase(readOnly)) { //备库
                    ResultSet rs1 = query(conn, "SHOW SLAVE STATUS");
                    if (com.urzz.plugin.rdbms.util.DBUtil.asyncResultSetNext(rs1)) {
                        ...
                        if ("Yes".equalsIgnoreCase(ioRunning) && "Yes".equalsIgnoreCase(sqlRunning)) {
                            ...
                            com.urzz.plugin.rdbms.util.DBUtil.asyncResultSetNext(rs2);
    ...
    public static boolean hasInsertPrivilege(DataBaseType dataBaseType, String jdbcURL, String userName, String password, List<String> tableList) {
        ...
        try {
            ...
            while (com.urzz.plugin.rdbms.util.DBUtil.asyncResultSetNext(rs)) {
        ...
        try {
            return RetryUtil.executeWithRetry(new Callable<Connection>() {
                ...
                public Connection call() throws Exception {
                    return com.urzz.plugin.rdbms.util.DBUtil.connect(dataBaseType, jdbcUrl, username,
    ...
    private static synchronized Connection connect(DataBaseType dataBaseType,
        ...
        //ob10的处理
        if (url.startsWith(com.urzz.plugin.rdbms.writer.Constant.OB10_SPLIT_STRING) && dataBaseType == DataBaseType.MySql) {
            String[] ss = url.split(com.urzz.plugin.rdbms.writer.Constant.OB10_SPLIT_STRING_PATTERN);
            if (ss.length != 3) {
    ...
    public static List<String> getTableColumnsByConn(DataBaseType dataBaseType, Connection conn, String tableName, String basicMsg) {
        ...
        try {
            ...
            com.urzz.plugin.rdbms.util.DBUtil.closeDBResources(rs, statement, conn);
        }
    ...
    public static Triple<List<String>, List<Integer>, List<String>> getColumnMetaData(
        ...
        try {
            ...
            com.urzz.plugin.rdbms.util.DBUtil.closeDBResources(null, null, conn);
        }
    }
    ...
    public static Triple<List<String>, List<Integer>, List<String>> getColumnMetaData(
        ...
        try {
            ...
            com.urzz.plugin.rdbms.util.DBUtil.closeDBResources(rs, statement, null);
        }
    }
    ...
    public static boolean testConnWithoutRetry(DataBaseType dataBaseType,
        ...
        try {
            ...
            com.urzz.plugin.rdbms.util.DBUtil.closeDBResources(null, connection);
        }
        return false;
    }
            ...
            return RetryUtil.executeWithRetry(new Callable<Boolean>() {
                ...
                public Boolean call() throws Exception {
                    ...
                    try {
                        ...
                        if (com.urzz.plugin.rdbms.util.DBUtil.asyncResultSetNext(rs, 5)) {
                        ...
                        com.urzz.plugin.rdbms.util.DBUtil.closeDBResources(null, conn);
                    }
                }
            }, 3, 1000L, true);
        } catch (Exception e) {
    ...
    private static boolean doPreCheck(Connection conn, String pre) {
        ...
        try {
            ...
            com.urzz.plugin.rdbms.util.DBUtil.closeResultSet(rs);
        }
        return false;
    }
    ...
    public static void dealWithSessionConfig(Connection conn,
        ...
        switch (databaseType) {
            case Oracle:
                ...
                com.urzz.plugin.rdbms.util.DBUtil.doDealWithSessionConfig(conn, sessionConfig, message);
                break;
            case DRDS:
                // 用于关闭 drds 的分布式事务开关
    ...
    private static void doDealWithSessionConfig(Connection conn,
        ...
        for (String sessionSql : sessions) {
            ...
            try {
                com.urzz.plugin.rdbms.util.DBUtil.executeSqlWithoutResultSet(stmt, sessionSql);
            } catch (SQLException e) {
                throw DataXException.asDataXException(
        ...
        com.urzz.plugin.rdbms.util.DBUtil.closeDBResources(stmt, null);
    }
