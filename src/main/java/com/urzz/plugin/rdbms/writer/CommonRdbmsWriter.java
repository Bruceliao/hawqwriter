package com.urzz.plugin.rdbms.writer;
...
import com.urzz.plugin.rdbms.writer.util.OriginalConfPretreatmentUtil;
import com.urzz.plugin.rdbms.writer.util.WriterUtil;
...
public class CommonRdbmsWriter {
    ...
    public static class Task {
        ...
        public void startWriteWithConnection(RecordReceiver recordReceiver, TaskPluginCollector taskPluginCollector, Connection connection) {
            ...
            LOG.info("startWriteWithConnection $$$$$$$$$$$$$$$$$$");
            // 写数据库的SQL语句
            calcWriteRecordSql();
...
//                LOG.info("writeRecrodSQL: ==>" + this.writeRecordSql);
...
//            LOG.info("record to SQL ===> " + preparedStatement.toString());
