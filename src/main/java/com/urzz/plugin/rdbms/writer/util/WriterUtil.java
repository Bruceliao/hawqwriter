package com.urzz.plugin.rdbms.writer.util;
...
import com.urzz.plugin.rdbms.writer.Constant;
import com.urzz.plugin.rdbms.writer.Key;
...
public final class WriterUtil {
    private static final Logger LOG = LoggerFactory.getLogger(com.urzz.plugin.rdbms.writer.util.WriterUtil.class);
    ...
    public static void preCheckPrePareSQL(Configuration originalConfig, DataBaseType type) {
        ...
        List<String> preSqls = originalConfig.getList(Key.PRE_SQL,
                String.class);
        List<String> renderedPreSqls = com.urzz.plugin.rdbms.writer.util.WriterUtil.renderPreOrPostSqls(
                preSqls, table);
    ...
    public static void preCheckPostSQL(Configuration originalConfig, DataBaseType type) {
        ...
        List<String> postSqls = originalConfig.getList(Key.POST_SQL,
                String.class);
        List<String> renderedPostSqls = com.urzz.plugin.rdbms.writer.util.WriterUtil.renderPreOrPostSqls(
                postSqls, table);
